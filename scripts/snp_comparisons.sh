...
echo "strain1	strain2	traveler_strain1	traveler_strain2	timepoint_strain1	timepoint_strain2	comparison_type	total_SNPs	aln_length	SNPs_per_mbp" > $1
		...
		then
			...
			then
				...
				then
					...
					then
						COMPARISON_TYPE="within_traveler_within_timepoint"
					elif [[ "$timepoint1" != "$timepoint2" ]]
					then
						COMPARISON_TYPE="within_traveler_between_timepoint"
					fi
				elif [[ "$traveler1" != "$traveler2" ]]
				then
					COMPARISON_TYPE="between_traveler"
				fi
				echo "$strain1	$strain2	$traveler1	$traveler2	$timepoint1	$timepoint2	$COMPARISON_TYPE	$SNP	$ALNLENGTH	$SNP_PER_MBP" >> $1
